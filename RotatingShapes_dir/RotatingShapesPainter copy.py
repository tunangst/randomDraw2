...
class RotatingShapesPainter(RotatingShapesBase):
    ...
    def start(self):
        ...
        self.painter.drawEllipse(800, 0, 20, 20)
        self.painter.drawEllipse(700, 0, 20, 20)
        self.painter.drawEllipse(600, 0, 20, 20)
        self.painter.drawEllipse(500, 0, 20, 20)
        self.painter.drawEllipse(400, 0, 20, 20)
        self.painter.drawEllipse(300, 0, 20, 20)
        self.painter.drawEllipse(200, 0, 20, 20)
        self.painter.drawEllipse(100, 0, 20, 20)
