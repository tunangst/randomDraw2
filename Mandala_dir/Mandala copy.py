...
class Mandala():
            ...
            match loops_design:
                case 'random':
                    ...
                    loop_object['shape_array'] = self.build_shape(
                        chosen_shape_count, shapes_design, loop_count_tuple, None)
                    pass
                case 'same':
                    loop_object['shape_array'] = self.build_shape(
                        chosen_shape_count, shapes_design, loop_count_tuple)
                    pass
                case 'incremental':
                    pass
                case _:
    ...
    def build_shape(self, shape_count, shape_design, loop_count_tuple, force_shape=None):
        force_shape = None
        ...
        if force_shape == None and shape_design == 'same':
            chosen_shape_type = self.get_chosen_shape_type(shape_design)
...
def get_shape_count(max_shape_count, min_shape_count):
    ...
    # self.min_shape_count = 4
    return get_random(
        max_shape_count, min_shape_count)


def get_shape_type(shape_design, loop_count_tuple, previous_chosen_shape_type=None):
